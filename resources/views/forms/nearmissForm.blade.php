                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Nearmiss</li>
                        </ol>
                    </div>
                    <h4 class="page-title">{{ __('Nearmiss') }}</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                    ...
                    <div class="row">
                        <div style="border: 1px dashed black; border-radius: 3px"
                            ...
                            <div class="d-flex flex-row justify-content-between">
                                <h3 class="mb-4">{{ __('Nearmiss') }} #162 </h3>
                            ...
                            <form>
                                ...
                                <x-form.form-date-input label="{{ __('Target Date') }}"/>
                                ...
                                <div class="d-flex flex-row justify-content-start ">
                                    <x-form.form-select-input label="{{ __('Incident Related To') }}" class="ml-1">
                                        <option selected>{{ __('Select') }}</option>
                                ...
                                <x-form.form-textarea-input label="{{ __('Root Cause Of Nearmiss') }}" rows="2"/>

                                <x-form.form-textarea-input label="{{ __('Steps Taken To Prevent Nearmiss') }}" rows="2"/>
